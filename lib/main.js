...
function evalTokens(_a, pwd, vars, importer) {
    ...
    if (vars === void 0) { vars = {}; }
    var result = '';
    var context = __assign(__assign({}, vars), { write: function (s) { return s; }, writeln: function (s) { return s; }, load: function (p) { return importFile(path_1.default.resolve(pwd, p), importer); } });
